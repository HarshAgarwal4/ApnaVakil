...
const DraftChat = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full min-h-0 rounded-xl md:rounded-2xl bg-white/80 backdrop-blur border border-gray-200 shadow-sm overflow-hidden">

      {/* Messages */}
      <div className="flex-1 min-h-0 overflow-y-auto p-3 md:p-5 space-y-4 md:space-y-5 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
      ...
      <div className="border-t border-gray-200 bg-white p-2 md:p-3">
        <div className="flex items-end gap-2 bg-gray-50 rounded-xl px-3 py-2 focus-within:ring-2 focus-within:ring-blue-400 transition">
          ...
          <textarea
            ...
            className="flex-1 resize-none bg-transparent px-2 py-1 focus:outline-none text-sm max-h-32"
            onKeyDown={(e) => {
