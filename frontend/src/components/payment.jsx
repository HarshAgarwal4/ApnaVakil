...
export default function PricingBox() {
    ...
    // ✅ Fetch past payments when dashboard opens
    useEffect(() => {
                ...
                handler: async (response) => {
                    ...
                    if (verifyRes.data.success) {
                        ...
                        while (i < 3) {
                            ...
                            i++; // increment counter every time
    ...
    return (
        <>
          ...
          text-center border border-gray-200 z-50 transition-all duration-300
        "
            >
                <nav className="flex justify-between items-center mb-4">
                    <h1 className="text-xl font-bold text-gray-800">Apna Vakil</h1>
                    <button
                ...
                <div className="border-t border-b border-gray-100 py-6 mb-6">
                    <h2 className="text-4xl sm:text-5xl font-bold text-gray-800">₹20</h2>
                    <p className="text-gray-500 mt-2">One-time access</p>
                </div>
                ...
                <button
                    ...
                    className="w-full border border-blue-500 text-blue-600 hover:bg-blue-50 py-2 rounded-xl font-semibold text-sm transition-all duration-300"
                >
                    View Past Payments
                </button>
