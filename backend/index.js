...
import directChatRouter from './App/Users/Routes/directChat.js';
...
const corsOptions = {
  origin: process.env.production === 'true'
    ...
    : [process.env.FRONTEND_URL, process.env.ADMIN_URL, "http://localhost:5173", "http://localhost:3000"],
  credentials: true,
};
